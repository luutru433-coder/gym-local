...
Gói dinh dưỡng lớn không nằm trong Git. Bản phát hành chính thức được lưu ở GitHub Release và workflow Pages kiểm tra SHA-256 trước khi đưa tệp vào site. Khi self-host thủ công, đặt `gym-local-nutrition-2026.04.sqlite3` cạnh `nutrition-pack-manifest.json` trong thư mục public/deploy.
