...
5. Verify backup v4 export/restore, backup v1/v2/v3 import, IndexedDB v1→v2→v3→v4 migration, pre-restore recovery/undo, active-workout refusal, and nutrition-pack preservation.
